<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
    ...
    <body id="root">
        <div class="w-full h-full overflow-y-auto" id="top">
          @yield('main-user-dashboard') 
        </div>
        <!-- Footer -->
        <div class="w-full another-section z-30 py-4 border border-white  bg-purple-700">
          ...
          <div class="link m-12 grid  xl:grid-cols-6 md:grid-cols-3 sm:grid-cols-2 space-y-4">
            <div class="flex items-start justify-center mr-10">
              ...
              <div class="products flex flex-col">
                ...
                <ul class="space-y-3 text-white">
                 <li><a href="{{ route('freefire.cards.home') }}" class="hover:underline">FreeFire cards</a></li>
              ...
              <div class="application flex flex-col">
                ...
                <ul class="space-y-3 text-white">
                 ...
                 <li><a href="{{ route('dashboard') }}" class="hover:underline">My Orders</a></li>
                 <li><a href="{{ route('transactions') }}" class="hover:underline">My Transactions</a></li>
          ...
          <div class="policy text-sm pb-4 text-center  space-x-2">
            <span><a class="hover:underline" href="{{ route('privacy-policy')}}">Privacy policy</a></span> <span class="text-center">|</span>
            <span><a class="hover:underline" href="">Responsible Disclosure Program policy</a></span><span class="text-center">|</span>
            <span><a class="hover:underline" href="{{ route('terms-and-conditions') }}">Terms and Conditions</a></span>
          </div>

          <hr class="text-white text-xl xl:py-8 py-4">
          <p class="text-white text-center text-xl">
            Copyright &copy; 2024 Herveson Jeudy tout droit sont réservée
          </p>
        </div>
