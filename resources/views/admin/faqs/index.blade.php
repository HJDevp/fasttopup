                ...
                @if ($faqs->isEmpty())
                  <tr class="w-full text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3 text-center text-purple-600">
                     Aucune faq n'est trouvé appuyer sur Add faq pour en ajouter !
                    </td>
                  </tr>
                @else
                <tbody
                  ...
                  >
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3 text-sm"> 
                        <a  class="cursor-pointer" @click="openModal">{{ nl2br($faq->question) }}</a>
                      </td>
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                            <form action="{{ route('admin.faqs.edit', $faq) }}" method="get">
                              @csrf  
