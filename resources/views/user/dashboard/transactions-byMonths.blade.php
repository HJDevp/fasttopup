        ...
        <div class="w-full">
            ...
            <div x-data="{ openTab: 1 }" class="p-0">
                ...
                <div class="search-by-date flex items-center justify-end pb-1">
                    ...
                    >
                        ...
                        <div>
                         ...
                         'select_class' => 'block dark:bg-transparent py-1 w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select 
                ...
                <div class="xl:w-full">
                    ...
                    @if(!$searchByMonth->isEmpty())
                    @foreach($searchByMonth as $transaction)
                    ...
                    @endforeach
                    @else
                      <p class="text-purple-700 text-sm font-mono">Pas de transaction pour ce mois</p>
                    @endif
                </div>
                {{ $searchByMonth->links() }}
            </div>
