...
@section('title', 'moncash payment')

@section('main-principal')
    <div class="flex items-center justify-center overflow-y-scroll overflow-visible m-8">
        <div class="xl:w-2/5 p-4 bg-white shadow-xs transform hover:-translate-y-1 border-1 
           border-solid   dark:bg-transparent rounded-lg">
            <!-- section 1-->
            <h1 class="text-2xl text-center font-bold capitalize dark:text-gray-200">Formulaire de paiement</h1>
            ...
            <div class="flex flex-col items-center justify-center space-y-2">
              ...
              <img src="{{ asset('../assets/img/paiement/MC_button_fr.png') }}"  class="w-20" alt="">
            </div>
                ...
                <form action="{{ route('controlTransaction', $freefirecard) }}" method="post"
                 enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        'name' => 'nom', 'label' => 'block text-sm', 'placeholder' => 'nom du compte moncash'])  
                    ...
                    <div>
                        @include('shared.input', ['class' => 'block w-full mt-1 text-sm dark:border-gray-600 dark:bg-transparent
                        focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray',
                        'name' => 'prenom', 'label' => 'block text-sm', 'placeholder' => 'prenom du compte moncash'])  
                    ...
                    <div>
                        @include('shared.input', ['class' => 'block w-full mt-1 text-sm dark:border-gray-600 dark:bg-transparent
                        focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray',
                        'name' => 'telephone', 'label' => 'block text-sm', 'placeholder' => 'numero moncash', 'type' => 'number'])  
                    ...
                    <div class="flex items-center gap-3">
                      @include('shared.input', ['class' => 'block w-full mt-1 text-sm dark:border-gray-600  dark:bg-transparent 
                      focus:border-purple-400 focus:outline-none relative rounded-tr-full rounded-br-full focus:shadow-outline-purple 
