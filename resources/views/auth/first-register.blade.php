<x-guest-layout>
    <form method="POST" class="mx-auto" action="{{ route('register') }}">
        ...
        <div class="input-group flex max-[460px]:flex-col gap-3 my-4">
            <!-- Name -->
            <div class="lg:w-1/2">
        ...
        <div class="input-group flex max-[460px]:flex-col gap-3">
            <!-- Email Address -->
            <div class="lg:w-1/2">
            ...
            <div class="lg:w-1/2">
                ...
                <x-text-input id="phone" class="block mt-1 w-full" type="text" name="numero_telephone" :value="old('numero_telephone')" required autofocus autocomplete="name" />
